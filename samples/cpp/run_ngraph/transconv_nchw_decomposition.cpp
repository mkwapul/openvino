...
NGRAPH_RTTI_DEFINITION(ngraph::pass::TransposeConvolutionNchwDecomposition, "TransposeConvolutionNchwDecomposition", 0);
bool ngraph::pass::TransposeConvolutionNchwDecomposition::run_on_function(std::shared_ptr<ngraph::Function> f) {
