...
rem .\Debug\run_ngraph.exe .\test8-2-2-bias.xml transposeconv
...
rem .\Debug\run_ngraph.exe .\convtrans.xml transposeconv
...
rem .\Debug\speech_sample.exe -m .\test8-2-2-bias.xml -i .\test16_input.ark -d CPU -o test8-2-2-bias_mkldnn.ark
...
rem .\Debug\speech_sample.exe -m .\convtrans.xml -i .\convtrans_input.ark -d CPU -o convtrans_mkldnn.ark
...
rem .\Debug\speech_sample.exe -m .\test8-2-2-bias_factorized.xml -i .\test16_input.ark -d CPU -r test8-2-2-bias_mkldnn.ark -o test8-2-2-bias_factorized_mkldnn.ark 
...
rem .\Debug\speech_sample.exe -m .\convtrans_factorized.xml -i .\convtrans_input.ark -d CPU -r convtrans_mkldnn.ark -o convtrans_factorized_mkldnn.ark 
