...
NGRAPH_RTTI_DEFINITION(ngraph::pass::GroupConvolution1dDecomposition, "GroupConvolution1dDecomposition", 0);
bool ngraph::pass::GroupConvolution1dDecomposition::run_on_function(std::shared_ptr<ngraph::Function> f) {
